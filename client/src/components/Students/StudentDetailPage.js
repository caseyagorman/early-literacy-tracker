...
const StudentDetailPage = props => (
  <Grid style={{ fontFamily: "Krub" }}>
    <Row>
      <Col>
        <h1 style={{ display: "inline-block" }}>{props.student.name}</h1>
        <DeleteStudent
      ...
      >
        <Col>
          ...
          <OverlayTrigger
            ...
            overlay={
              <Tooltip>
                Test {props.student.name.split(" ")[0]}'s words, letters, or
                sounds
              </Tooltip>
            }
          >
            <div style={{ width: 110, display: "inline-block" }}>
              <DropdownBar
                ...
                letterAction={
                  <Link
                    to={`/test-student/letters/${props.student.student_id}`}
                    onClick={() =>
                ...
                soundAction={
                  <Link
                    to={`/test-student/sounds/${props.student.student_id}`}
          ...
          <OverlayTrigger
            ...
            overlay={
              <Tooltip>
                View {props.student.name.split(" ")[0]}'s previous word, letter,
                and sound test results
              </Tooltip>
            }
          >
          ...
          <div style={{ width: 60, display: "inline-block" }}>
            ...
            >
              <Link to={`/student-item-charts/${props.student.student_id}`}>
                <button
                  style={{ marginLeft: 1 }}
          ...
          >
            <div style={{ width: 110, display: "inline-block" }}>
              <DropdownBar
                ...
                wordAction={
                  <Link
                    to={`/add-custom-items/${props.student.student_id}/words`}
                  >
                    Add Words
                  </Link>
                }
                letterAction={
                  <Link
                    to={`/add-custom-items/${props.student.student_id}/letters`}
                  >
                    Add Letters
                  </Link>
                }
                soundAction={
                  <Link
                    to={`/add-custom-items/${props.student.student_id}/sounds`}
                  >
                    Add Sounds
                  </Link>
                }
          ...
          <AssignReadingLevel
            ...
            student={props.student.name.split(" ")[0]}
          />
        </Col>
      </div>
      <div style={{ float: "right", marginTop: 80 }}>
        <Col>
          <ClassAverageChart student={props.student} />
        </Col>
      </div>
    </Row>
